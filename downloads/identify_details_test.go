...
func TestIdentify(t *testing.T) {
	...
	tests := []struct {
		...
		{"mysql-8.4.7-linux-glibc2.28-aarch64.tar.xz", "mysql", "8.4.7", "8.4", "aarch64", "linux", false},
		{"mysql-8.4.7-linux-glibc2.28-x86_64-minimal.tar.xz", "mysql", "8.4.7", "8.4", "x86_64", "linux", true},
		{"mysql-9.5.0-macos15-arm64.tar.gz", "mysql", "9.5.0", "9.5", "arm64", "Darwin", false},
		...
		{"villagesql-server-0.0.3-linux-glibc2.28-x86_64.tar.xz", "villagesql", "0.0.3", "0.0", "x86_64", "linux", false},
		{"villagesql-server-0.0.4-linux-glibc2.28-x86_64.tar.gz", "villagesql", "0.0.4", "0.0", "x86_64", "linux", false},
