...
type DbdeployerDefaults struct {
	...
	MysqlRouterPath               string `json:"mysql-router"`
...
var (
	...
	factoryDefaults = DbdeployerDefaults{
		...
		RemoteCompletionUrl:           "https://raw.githubusercontent.com/dbdeployer/dbdeployer/master/docs/dbdeployer_completion.sh",
...
func UpdateDefaults(label, value string, storeDefaults bool) {
	...
	case "mysql-router":
		newDefaults.MysqlRouterPath = value
...
func DefaultsToMap() common.StringMap {
	...
	return common.StringMap{
		...
		"MysqlRouterPath":                   currentDefaults.MysqlRouterPath,
		"mysql-router":                      currentDefaults.MysqlRouterPath,
