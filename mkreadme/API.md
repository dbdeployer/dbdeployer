...
dbdeployer 1.76.0 as of 22-May-2026 12:22 UTC
...
## downloads
    ...
    Flags:
          --change-user-agent   Use alternative user agent ('Firefox' instead of 'dbdeployer')
      -h, --help                help for add-remote
          --minimal             Define whether the wanted tarball is a minimal one
          --overwrite           Overwrite existing entry
    
    
    $ dbdeployer downloads add-url -h
    Adds a URL containing a tarball to the list of tarballs
    
    Usage:
      dbdeployer downloads add-url  [flags]
    
    Flags:
      -h, --help   help for add-url
    ...
    Flags:
      -h, --help                     help for import
          --merge-imported           Merge imported file instead of replacing current one
          --retries-on-failure int   How many times retry a download if a failure occurs on first try
